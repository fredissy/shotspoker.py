...
from src.store import get_room, room_exists
...
def admin_panel():
    ...
    # 1. Scan Redis for all keys starting with "room:"
    # scan_iter is safe for production (doesn't block like keys())
    ...
    return render_template('admin.html.j2', rooms=rooms_data)
